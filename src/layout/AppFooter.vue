        ...
        <div class="container">
            <div class="row row-grid align-items-center my-md">
                ...
                <div class="col-lg-6 text-lg-center btn-wrapper">
                    ...
                    <a target="_blank" rel="noopener" href="https://github.com/users/DavionKalhen/projects/1"
            ...
            <div class="row align-items-center justify-content-md-between">
                <div class="col-md-6">
                    <div class="copyright">
                        &copy; {{year}}
                        <a href="http://telikos.io/" target="_blank" rel="noopener">Telikos</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <ul class="nav nav-footer justify-content-end">
                        <li class="nav-item">
                            <a href="http://telikos.io/" class="nav-link" target="_blank" rel="noopener">Telikos</a>
                        </li>
                        <li class="nav-item">
